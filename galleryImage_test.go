...
func TestGalleryImageImgurSimulated(t *testing.T) {
	...
	if img.Title != "The Tridge. (three way bridge)" || img.Animated != false || img.Bandwidth != 359974438182 || img.Datetime != 1316367003 || img.Description != "" || img.Height != 1133 || img.Width != 1700 || img.ID != "Hf6cs" || img.Link != "http://i.imgur.com/Hf6cs.jpg" || img.Views != 1342557 {
		t.Fail()
	}
...
func TestGalleryImageImgurReal(t *testing.T) {
	...
	if img.Title != "The Tridge. (three way bridge) " || img.Animated != false || img.Description != "" || img.Height != 1133 || img.Width != 1700 || img.ID != "Hf6cs" || img.Link != "http://i.imgur.com/Hf6cs.jpg" {
		t.Fail()
	}
